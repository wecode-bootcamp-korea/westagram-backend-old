...
from .views      import PostsView, PostDetailView, CommentView, CommentListView, LikeView, LikeListView, ReplyToCommentsView
...
urlpatterns = [
    ...
    path('/comment/<int:comment_id>/reply', ReplyToCommentsView.as_view(), name='reply'),
]
